		...
		<div class="form">
			<form
				...
				<label for="id">Id Alumno</label> <input type="text" id="id"
					...
					id="apellido" name="apellido"><br> Familia Numerosa: <input
					type="checkbox" id="famNumerosa" name="famNumerosa" value="1"
					checked> Activo: <input type="checkbox" id="activo"
					name="activo" value="1" checked><br> <input
...
<div class="form">
<form
action="http://localhost:8080/colegio/alumnos/actualizarAlumno"
method="post">
...
value="${alumno.nombre}"><br>
<label for="apellido">Apellido Alumno</label>
<input type="text" id="apellido" name="apellido"
value="${alumno.apellido}"><br>
Familia Numerosa:
<c:if test="${alumno.familiaNumerosa == 1}">
<input type="checkbox" id="famNumerosa"
name="famNumerosa" value="1" checked>
</c:if>
<c:if test="${alumno.familiaNumerosa == 0}">
<input type="checkbox" id="famNumerosa"
name="famNumerosa" value="1">
</c:if>
Activo:
